...
public enum class ArticleStatus {
    DRAFT,
    PUBLISHED,
}
...
public class Article(
    ...
    @ManyToOne public var category: Category? = null,
    ...
    @ManyToMany public var tags: MutableSet<Tag> = mutableSetOf(),
    ...
    public var slug: String = title.toSlug(),
    // When the article was created. Defaults to now; used for sorting in "newest first" views.
    public var addedAt: LocalDateTime = LocalDateTime.now(),
    ...
    public var status: ArticleStatus = ArticleStatus.DRAFT,
    ...
    public var scheduledAt: LocalDateTime? = null,
    // Database primary key (auto-generated)
    @Id @GeneratedValue public var id: Long? = null,
)
...
public class Comment(
    ...
    @ManyToOne public var article: Article,
    ...
    @Column(length = 2000) public var content: String,
...
public class Category(
    ...
    // routes.
    public var slug: String = name.toSlug(),
    // Database primary key (auto-generated)
    @Id @GeneratedValue public var id: Long? = null,
)
